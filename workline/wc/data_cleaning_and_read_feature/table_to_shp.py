...
if __name__ == "__main__":
    input_file = r"E:\soil_property_result\wcx\cleaned_data.csv"
    output_file = r"E:\soil_property_result\wcx\shp\wc_result_point.shp"
    os.makedirs(Path(output_file).parent, exist_ok=True)
    lon_col = 'DWJD'
    lat_col = 'DWWD'
    input_crs = 4326
    output_crs = 4545
    log_file = r"E:\soil_property_result\wcx\logs\table_to_shp.log"
