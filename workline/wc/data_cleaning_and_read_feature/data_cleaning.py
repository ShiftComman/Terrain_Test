...
if __name__ == "__main__":
    df_path = r"E:\soil_property_result\wcx\table\result_ana_df_20250217_205705.xlsx"
    lon_col = 'DWJD' # 经度列名
    lat_col = 'DWWD' # 纬度列名
    columns =  ['PH','CEC','OM','TN','TP','TK','TSE','AP','SK','AK',
                     'HG','AS2','PB','CD','CR','TRRZ','GZCHD','YXTCHD'] # 需要清洗的标签列
    output_folder = r"E:\soil_property_result\wcx"
    log_file = r'E:\soil_property_result\wcx\logs\data_cleaning.log'
