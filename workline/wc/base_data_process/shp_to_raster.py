...
if __name__ == "__main__":
    vector_path = r'F:\cache_data\shp_file\wc\wc_sd_polygon.shp'  # 矢量文件路径
    value_field = 'DLDM'  # 用于栅格化的矢量字段名
    reference_tif_path = r'F:\tif_features\county_feature\wc\dem.tif'  # 参考 TIF 文件路径
    output_tif_path = r'F:\tif_features\temp\calc\dl.tif' # 输出 TIF 文件路径
