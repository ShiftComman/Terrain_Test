...
if __name__ == "__main__":
    point_shp_path = r'F:\cache_data\shp_file\sb\sb_filter_points_train.shp'
    raster_folder_path = r'F:\tif_features\county_feature\sb'
    output_csv_path = r'F:\cache_data\zone_ana\sb\train_data\soil_type_point.csv'
    keep_out_of_bounds = True
    fill_value = np.nan
    log_file = r'F:\cache_data\zone_ana\sb\train_data\point_sample.log'
