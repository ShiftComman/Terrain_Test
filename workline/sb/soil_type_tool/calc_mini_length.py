...
def process_shapefile(input_shp, output_shp=None):
    ...
    # 保存到输入路径
    logger.info(f"保存结果到: {input_shp}")
    gdf.to_file(input_shp, encoding='utf-8')
    # 输出统计信息
    logger.info("\n统计信息:")
...
if __name__ == "__main__":
    ...
    input_shp = r"C:\Users\Runker\Desktop\ele_sb\sb_merge_data_single_result_fast.shp"
    
    process_shapefile(input_shp)