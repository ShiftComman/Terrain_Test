...
if __name__ == "__main__":
    input_file = r"E:\soil_property_result\sbx\cleaned_data.csv"
    output_file = r"E:\soil_property_result\sbx\shp\sb_result_point.shp"
    os.makedirs(Path(output_file).parent, exist_ok=True)
    lon_col = 'DWJD'
    lat_col = 'DWWD'
    input_crs = 4326
    output_crs = 4545
    log_file = r"E:\soil_property_result\sbx\logs\table_to_shp.log"
