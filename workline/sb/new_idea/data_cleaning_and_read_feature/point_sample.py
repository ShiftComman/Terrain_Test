...
if __name__ == "__main__":
    point_shp_path = r"E:\soil_property_result\sbx\shp\sb_result_point.shp"
    raster_folder_path = r'F:\tif_features\county_feature\sb'
    output_csv_path = r'E:\soil_property_result\sbx\table\soil_property_point.csv'
    keep_out_of_bounds = True
    fill_value = 0
    log_file = r'E:\soil_property_result\sbx\logs\point_sample.log'
