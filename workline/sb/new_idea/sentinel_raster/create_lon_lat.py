...
if __name__ == "__main__":
    input_path = r'F:\tif_features\county_feature\wc\dem.tif'
    output_path = r'F:\tif_features\county_feature\wc'
    log_file = r'F:\tif_features\temp\calc\logs\create_lon_lat_wc.log'
