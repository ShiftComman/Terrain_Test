...
if __name__ == "__main__":
    # 配置参数
    config = {
        "log_file": r"E:\soil_property_result\sbx\logs\predict_soil_properties.log", # 日志文件路径
        "model_dir": r"E:\soil_property_result\sbx\models\soil_property\models", # 模型文件路径
        "feature_dir": r"F:\tif_features\county_feature\sb", # 特征文件路径
        "output_dir": r"E:\soil_property_result\sbx\soil_property_predict", # 输出文件路径
        "training_data_path": r"E:\soil_property_result\sbx\table\soil_property_point.csv", # 训练数据路径
        "coord_cols": ["lon", "lat"], # 坐标列
        "use_rk": True, # 是否使用RFRK模型
        "shapefile_path": r"F:\soil_mapping\sb\soil-mapping\data\raw\study_area\study_area.shp", # 掩膜矢量文件路径
