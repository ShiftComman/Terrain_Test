...
if __name__ == "__main__":
    region_path = r'F:\cache_data\shp_file\wc\wc_extent_d_1000.shp'
    output_folder = r'F:\tif_features\temp\sentinel'
    start_date = '2023-01-01'
    end_date = '2023-12-31'
    log_file = r'F:\tif_features\temp\sentinel\logs\download_gees2.log'
    num_groups = 1
    # 将研究区域划分为1组进行处理
