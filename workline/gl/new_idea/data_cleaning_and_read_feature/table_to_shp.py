...
if __name__ == "__main__":
    input_file = r"G:\soil_property_result\glx\cleaned_data.csv"
    output_file = r"G:\soil_property_result\glx\shp\glx_result_point.shp"
    os.makedirs(Path(output_file).parent, exist_ok=True)
    lon_col = 'DWJD'
    lat_col = 'DWWD'
    input_crs = 4326
    output_crs = 4544
    log_file = r"G:\soil_property_result\glx\logs\table_to_shp.log"
