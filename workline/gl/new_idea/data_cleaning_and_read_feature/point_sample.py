...
if __name__ == "__main__":
    point_shp_path = r"G:\soil_property_result\glx\shp\glx_result_point.shp"
    raster_folder_path = r'G:\tif_features\county_feature\gl'
    output_csv_path = r'G:\soil_property_result\glx\table\soil_property_point.csv'
    keep_out_of_bounds = True
    fill_value = 0
    log_file = r'G:\soil_property_result\glx\logs\point_sample.log'
