...
if __name__ == "__main__":
    input_path = r'F:\tif_features\county_feature\dj\dem.tif'
    output_path = r'F:\tif_features\county_feature\dj'
    log_file = r'F:\tif_features\temp\calc\logs\create_lon_lat_dj.log'
