...
if __name__ == "__main__":
    input_dir = r'F:\GEEDOWNLOAD\sentinel2\DJ'
    output_path = r'F:\cache_data\tif_file_sentinel\dj\dj_bands14.tif'
    target_crs = 'EPSG:4545'
    log_file = r'F:\cache_data\tif_file_sentinel\dj\logs\mosaic.log'
