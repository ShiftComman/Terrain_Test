...
if __name__ == "__main__":
    region_path = r'F:\cache_data\shp_file\dj\dj_extent_p_1000.shp'
    output_folder = r'F:\GEEDOWNLOAD\sentinel2\DJ'
    start_date = '2023-10-01'
    end_date = '2023-12-31'
    log_file = r'F:\GEEDOWNLOAD\sentinel2\DJ\logs\download_gee.log'
    num_groups = 1
    # 将研究区域划分为1组进行处理
