...
if __name__ == "__main__":
    input_dir = r'F:\GEEDOWNLOAD\sentinel2\FQ'
    output_path = r'F:\cache_data\tif_file_sentinel\fq\fq_bands14.tif'
    target_crs = 'EPSG:4545'
    log_file = r'F:\cache_data\tif_file_sentinel\fq\logs\mosaic.log'
