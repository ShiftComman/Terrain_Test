...
if __name__ == "__main__":
    base_raster = r'G:\tif_features\county_feature\ky\dem.tif'
    input_vector = r'F:\cache_data\shp_file\ky\ky_extent.shp'
    other_rasters_path = r"F:\tif_features\temp\calc"
    output_folder = r"G:\tif_features\county_feature\ky"
