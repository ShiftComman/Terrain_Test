...
if __name__ == "__main__":
    file_path = r"G:\soil_property_result\kyx\table\soil_property_point.csv"
    label_cols = ['PH','CEC','OM','TN','TP','TK','TSE','AP','SK','AK','HG','AS2','PB','CD','CR','TRRZ','GZCHD','YXTCHD',]  # 修改为列表
    feature_cols = [ 'analyticalhillshading', 'aspect', 'bio', 'carbonate', 'channelnetworkbaselevel',
     'channelnetworkdistance', 'clay_minerals', 'contrast', 'convergenceindex', 'correlation',
     'dem', 'dissimilarity', 'dl', 'dz', 'entropy', 'etp22_3', 'etp22_mean', 'evi',
     'ferrous_minerals', 'homogeneity', 'lsfactor', 'lswi', 'mean', 'mndwi',
     'mrttf', 'mrvbf', 'ndmi', 'ndvi', 'ndwi', 'night22', 'pc1', 'pc2', 'plancurvature',
     'pre22_3', 'pre22_mean', 'profilecurvature', 'relativeslopeposition', 'rock_outcrop',
     'savi', 'secondmoment', 'slope', 'slope_postion', 'sra', 'tmp22_3', 'tmp22_mean',
     'topographicpositionindex', 'topographicwetnessindex', 'totalcatchmentarea', 'valleydepth',
     'vap', 'vari', 'variance', 'wind']
    coord_cols = ["lon", "lat"]
    param_grid = {
    ...
    save_dir = r'G:\soil_property_result\kyx\models\soil_property'
    log_file = r'G:\soil_property_result\kyx\logs\train_soil_property.log'
    cv = 10
