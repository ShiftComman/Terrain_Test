...
if __name__ == "__main__":
    base_raster = r'G:\tif_features\county_feature\dy\dem.tif'
    input_vector = r'F:\cache_data\shp_file\dy\dy_studyarea.shp'
    other_rasters_path = r"F:\tif_features\temp\calc"
    output_folder = r"G:\tif_features\county_feature\dy"
