...
if __name__ == "__main__":
    input_dir = r'F:\GEEDOWNLOAD\sentinel2\WC'
    output_path = r'F:\cache_data\tif_file_sentinel\wc\wc_bands14.tif'
    target_crs = 'EPSG:4545'
    log_file = r'F:\GEEDOWNLOAD\sentinel2\WC\logs\mosaic.log'
