...
if __name__ == "__main__":
    point_shp_path = r"G:\soil_property_result\dys\shp\dys_result_point.shp"
    raster_folder_path = r'G:\tif_features\county_feature\dy'
    output_csv_path = r'G:\soil_property_result\dys\table\soil_property_point.csv'
    keep_out_of_bounds = True
    fill_value = 0
    log_file = r'G:\soil_property_result\dys\logs\point_sample.log'
