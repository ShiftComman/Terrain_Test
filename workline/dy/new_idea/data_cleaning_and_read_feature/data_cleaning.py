...
if __name__ == "__main__":
    df_path = r"G:\soil_property_result\dys\table\result_ana_df_20250221_142348.xlsx"
    lon_col = 'DWJD' # 经度列名
    lat_col = 'DWWD' # 纬度列名
    columns =  ['PH','CEC','OM','TN','TP','TK','TSE','AP','SK','AK',
                     'HG','AS2','PB','CD','CR','TRRZ','GZCHD','YXTCHD'] # 需要清洗的标签列
    output_folder = r"G:\soil_property_result\dys"
    log_file = r'G:\soil_property_result\dys\logs\data_cleaning.log'
