...
if __name__ == "__main__":
    # 设置输入参数
    input_vector = r'F:\cache_data\shp_file\qz\dz\rock_type_result_20250219.shp'  # 输入矢量路径
    reference_raster = r"G:\tif_features\county_feature\qz\dem.tif"  # 参考栅格路径
    output_raster = r"G:\tif_features\county_feature\qz\dzz.tif"  # 输出栅格路径
    value_field = "MZMCDM"  # 可选：用于赋值的字段名
